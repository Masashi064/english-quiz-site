(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_ac10ec._.js", {
...
function FilterSidebar(props) {
    const { category, setCategory, channel, setChannel, level, setLevel, completion, setCompletion, allCategories, allChannels, sortKey, setSortKey, sortOrder, setSortOrder } = props;
    const resetFilters = ()=>{
        setCategory('all');
        setChannel('all');
        setLevel('all');
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                        value: "desc",
                                        children: "Desc (new → old / long → short)"
                                    }, void 0, false, {
                                        fileName: "[project]/app/components/FilterSidebar.tsx",
                                        lineNumber: 61,
                                        columnNumber: 13
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                        value: "asc",
                                        children: "Asc (old → new / short → long)"
                                    }, void 0, false, {
                                        fileName: "[project]/app/components/FilterSidebar.tsx",
                                        lineNumber: 62,
                                        columnNumber: 13
...
function TopArticleList({ articles }) {
    ...
    const [loadedCompletion, setLoadedCompletion] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [sortKey, setSortKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('published_at') // 既定＝動画公開日
    ;
    const [sortOrder, setSortOrder] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('desc') // 既定＝新しい順
    ;
    const parseDurationToSec = (s)=>{
        if (!s) return 0;
    ...
    const pubTime = (x)=>new Date(x?.published_at ?? x?.published_date ?? 0).getTime();
    const handleDrawerToggle = ()=>setDrawerOpen((prev)=>!prev);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TopArticleList.useEffect": ()=>{
            const fetchCompleted = {
                "TopArticleList.useEffect.fetchCompleted": async ()=>{
                    ...
                    const ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(db, 'users', user.uid, 'quizResults');
                    const snapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(ref);
                    const slugs = snapshot.docs.filter({
                        "TopArticleList.useEffect.fetchCompleted.slugs": (doc)=>doc.data().score > 0 && doc.data().slug
                    }["TopArticleList.useEffect.fetchCompleted.slugs"]).map({
                        "TopArticleList.useEffect.fetchCompleted.slugs": (doc)=>doc.data().slug
                    }["TopArticleList.useEffect.fetchCompleted.slugs"]);
                    setCompletedSlugs(slugs);
                }
            }["TopArticleList.useEffect.fetchCompleted"];
            fetchCompleted();
        }
    }["TopArticleList.useEffect"], [
        user,
...
_s(TopArticleList, "4ZME1RfGat3e9+teMW6VI3IuPi0=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$TopArticleList$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/components/TopArticleList.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$all$2d$articles$2e$json__$28$json$29$__ = __turbopack_import__("[project]/app/data/all-articles.json (json)");
'use client';
;
;
;
function HomePage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$TopArticleList$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        articles: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$all$2d$articles$2e$json__$28$json$29$__["default"]
    }, void 0, false, {
...
//# sourceMappingURL=app_ac10ec._.js.map